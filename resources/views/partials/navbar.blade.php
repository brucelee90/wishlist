            ...
            <div class="flex items-center">
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="{{ url('/welcome') }}" class="@if(\Illuminate\Support\Facades\Request::path()== 'welcome' | \Illuminate\Support\Facades\Request::path()== '/') bg-gray-900 @endif text-white px-3 py-2 rounded-md text-sm font-medium">Dashboard</a>
                        ...
                        <a href="{{ url('/test') }}" class="@if(\Illuminate\Support\Facades\Request::path()== 'settings') bg-gray-900 @endif text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Test</a>
                    </div>
                </div>
            </div>
        </div>
